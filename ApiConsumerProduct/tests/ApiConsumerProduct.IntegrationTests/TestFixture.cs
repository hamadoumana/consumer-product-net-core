namespace ApiConsumerProduct.IntegrationTests;

using ApiConsumerProduct.Extensions.Services;
using ApiConsumerProduct.Databases;
using ApiConsumerProduct.Resources;
using ApiConsumerProduct.SharedTestHelpers.Utilities;
using Resources;
...
using Xunit;
using static Resources.ApiConsumerProductOptions;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.ApiConsumerProductKey] = _dbContainer.GetConnectionString();
    ...
    {
        var options = new DbContextOptionsBuilder<ConsumerProductDbContext>()
            .UseNpgsql(connectionString)
            .Options;
        var context = new ConsumerProductDbContext(options, null, null, null);
