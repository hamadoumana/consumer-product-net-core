namespace ApiConsumerProduct.IntegrationTests.FeatureTests.RolePermissions;

using ApiConsumerProduct.SharedTestHelpers.Fakes.RolePermission;
using ApiConsumerProduct.Domain.RolePermissions.Features;
