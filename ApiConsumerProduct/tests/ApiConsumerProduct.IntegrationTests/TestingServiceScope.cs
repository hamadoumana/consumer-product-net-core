...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<ConsumerProductDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<ConsumerProductDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<ConsumerProductDbContext, Task<T>> action)
