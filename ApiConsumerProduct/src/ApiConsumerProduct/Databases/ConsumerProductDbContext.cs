namespace ApiConsumerProduct.Databases;

using ApiConsumerProduct.Domain;
using ApiConsumerProduct.Databases.EntityConfigurations;
...
public sealed class ConsumerProductDbContext(DbContextOptions<ConsumerProductDbContext> options, 
    ...
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        */
        ...
        modelBuilder.ApplyConfiguration(new ConsumerProductConfiguration());
...
public static void FilterSoftDeletedRecords(this ModelBuilder modelBuilder)
{
    ...
    }public static IQueryable<User> GetUserAggregate(this ConsumerProductDbContext dbContext)
{
