namespace ApiConsumerProduct.Databases.EntityConfigurations;

using ApiConsumerProduct.Domain.ConsumerProducts;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

public sealed class ConsumerProductConfiguration : IEntityTypeConfiguration<ConsumerProduct>
{
    /// <summary>
    /// The database configuration for ConsumerProducts. 
    /// </summary>
